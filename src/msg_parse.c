...
int parse(t_string * recv, int len, t_msg * msg) {
    ...
    switch ((*recv)[0]) {
        case e_confirm: return parse_confirm(recv, len, msg); break;
        case e_reply: return parse_reply(recv, len, msg); break;
        case e_auth: return parse_auth(recv, len, msg); break;
        case e_join: return parse_join(recv, len, msg); break;
        case e_msg: return parse_msg(recv, len, msg); break;
        case e_err: return parse_err(recv, len, msg); break;
        case e_bye: return parse_bye(recv, len, msg); break;
